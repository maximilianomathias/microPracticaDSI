...
export class AppComponent {
  title = 'Micro 2 - Angular';
  public EstadoCoche: any = EstadoCoche; 
  public coches:Array<Coche>=[
    new Coche('renault', 'scenic', new Date(2007, 10, 1), new Date(2018, 3, 1), 5000, 'scenic.jpg', EstadoCoche.BUENO),
    new Coche('seat', 'ibiza', new Date(2003, 4, 12), new Date(2018, 2, 1), 1200, 'ibiza.jpg', EstadoCoche.BUENO),
    new Coche('renault', 'megane', new Date(2006, 12, 23), new Date(2018, 2, 1), 3500, 'megane.jpg', EstadoCoche.MALO),
